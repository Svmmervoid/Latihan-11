...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Data untuk Member Baru di Bawah</h6>
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('post.proses-tambah.member') }}" method="post">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="trainer-id form-control custom-select" name="trainer_ke">
                        ...
                        <option value="{{ $trainer->id }}" {{ old('trainer_id') == $trainer->id ? 'selected' : '' }}>{{ $trainer->nama }}</option>
                        @endforeach
                    </select>
